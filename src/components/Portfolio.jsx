...
const VIDEOS = [
  { id: "1210526978", titulo: "Porque Mevino" },
  { id: "1210526972", titulo: "Aenergetic" },
  { id: "1210526974", titulo: "Loritos" },
  { id: "1210526973", titulo: "Pata de Pulpo" },
...
const CATEGORIAS = [
  "Todos",
  ...new Set(VIDEOS.filter((v) => v.categoria).map((v) => v.categoria)),
];
  ...
  return (
    <div
      style={{
        ...
        transition:
          "transform 0.35s cubic-bezier(0.16,1,0.3,1), box-shadow 0.35s ease, border-color 0.25s ease",
        cursor: "pointer",
      }}
      onMouseEnter={() => setHovered(true)}
      onMouseLeave={() => setHovered(false)}
...
export default function Portfolio() {
  ...
  const filtrados =
    activa === "Todos" ? VIDEOS : VIDEOS.filter((v) => v.categoria === activa);
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(150deg, #0c3838 0%, #072424 55%, #061a1a 100%)",
          }}
        >
          {/* Blobs */}
          <div
            ...
            style={{
              ...
              filter: "blur(50px)",
              background:
                "radial-gradient(circle, #1a7a6e 0%, transparent 70%)",
          ...
          <div
            ...
            style={{
              ...
              filter: "blur(50px)",
              background:
                "radial-gradient(circle, #e8621a 0%, transparent 70%)",
          ...
          <Reveal className="relative mb-7">
            <div style={{ padding: "0 clamp(24px,5vw,72px)" }}>
              ...
              <h2
                className="font-mozilla font-bold text-cream"
                style={{
